 ...
 * @author Paulina
 */
public class GameInterface1 extends javax.swing.JFrame {
    // Composition of the logic level to the game interface of level 1
    private Level level;
    ...
    public void empezarJuego(){
        ...
        block1.setText(String.valueOf(level.matrizCorrecta1[0][0]));
        //COLOR DEL FONDO DE LA TEXTFIELD
        block1.setBackground(Color.CYAN);
        // FALSE PARA QUE EL USUARIO NO PUEDA EDITAR ESA TEXTFIELD
        block1.setEditable(false);
        block2.setText(String.valueOf(level.matrizCorrecta1[0][1]));
        block2.setBackground(Color.CYAN);
        block2.setEditable(false);
        block4.setText(String.valueOf(level.matrizCorrecta1[1][0]));
        block4.setBackground(Color.CYAN);
        block4.setEditable(false);
        block6.setText(String.valueOf(level.matrizCorrecta1[1][2]));
        block6.setBackground(Color.CYAN);
        block6.setEditable(false);
        block8.setText(String.valueOf(level.matrizCorrecta1[2][1]));
        block8.setBackground(Color.CYAN);
        block8.setEditable(false);
        block9.setText(String.valueOf(level.matrizCorrecta1[2][2]));
        block9.setBackground(Color.CYAN);
        block9.setEditable(false);
        block10.setText(String.valueOf(level.matrizCorrecta1[3][0]));
        block10.setBackground(Color.CYAN);
        block10.setEditable(false);
        block11.setText(String.valueOf(level.matrizCorrecta1[3][1]));
        block11.setBackground(Color.CYAN);
        block11.setEditable(false);
        block12.setText(String.valueOf(level.matrizCorrecta1[3][2]));
        block12.setBackground(Color.CYAN);
        block12.setEditable(false);
        block13.setText(String.valueOf(level.matrizCorrecta1[4][0]));
        block13.setBackground(Color.CYAN);
        block13.setEditable(false);
        block19.setText(String.valueOf(level.matrizCorrecta1[6][0]));
        block19.setBackground(Color.CYAN);
        block19.setEditable(false);
        block21.setText(String.valueOf(level.matrizCorrecta1[6][2]));
        block21.setBackground(Color.CYAN);
        block21.setEditable(false);
        block22.setText(String.valueOf(level.matrizCorrecta1[7][0]));
        block22.setBackground(Color.CYAN);
        block22.setEditable(false);
        block23.setText(String.valueOf(level.matrizCorrecta1[7][1]));
        block23.setBackground(Color.CYAN);
        block23.setEditable(false);
        block26.setText(String.valueOf(level.matrizCorrecta1[8][1]));
        block26.setBackground(Color.CYAN);
        block26.setEditable(false);
        block28.setText(String.valueOf(level.matrizCorrecta1[0][3]));
        block28.setBackground(Color.CYAN);
        block28.setEditable(false);
        block29.setText(String.valueOf(level.matrizCorrecta1[0][4]));
        block29.setBackground(Color.CYAN);
        block29.setEditable(false);
        block31.setText(String.valueOf(level.matrizCorrecta1[1][3]));
        block31.setBackground(Color.CYAN);
        block31.setEditable(false);
        block34.setText(String.valueOf(level.matrizCorrecta1[2][3]));
        block34.setBackground(Color.CYAN);
        block34.setEditable(false);
        block39.setText(String.valueOf(level.matrizCorrecta1[3][5]));
        block39.setBackground(Color.CYAN);
        block39.setEditable(false);
        block41.setText(String.valueOf(level.matrizCorrecta1[4][4]));
        block41.setBackground(Color.CYAN);
        block41.setEditable(false);
        block42.setText(String.valueOf(level.matrizCorrecta1[4][5]));
        block42.setBackground(Color.CYAN);
        block42.setEditable(false);
        block43.setText(String.valueOf(level.matrizCorrecta1[5][3]));
        block43.setBackground(Color.CYAN);
        block43.setEditable(false);
        block44.setText(String.valueOf(level.matrizCorrecta1[5][4]));
        block44.setBackground(Color.CYAN);
        block44.setEditable(false);
        block45.setText(String.valueOf(level.matrizCorrecta1[5][5]));
        block45.setBackground(Color.CYAN);
        block45.setEditable(false);
        block53.setText(String.valueOf(level.matrizCorrecta1[8][4]));
        block53.setBackground(Color.CYAN);
        block53.setEditable(false);
        block54.setText(String.valueOf(level.matrizCorrecta1[8][5]));
        block54.setBackground(Color.CYAN);
        block54.setEditable(false);
        block55.setText(String.valueOf(level.matrizCorrecta1[0][6]));
        block55.setBackground(Color.CYAN);
        block55.setEditable(false);
        block56.setText(String.valueOf(level.matrizCorrecta1[0][7]));
        block56.setBackground(Color.CYAN);
        block56.setEditable(false);
        block59.setText(String.valueOf(level.matrizCorrecta1[1][7]));
        block59.setBackground(Color.CYAN);
        block59.setEditable(false);
        block60.setText(String.valueOf(level.matrizCorrecta1[1][8]));
        block60.setBackground(Color.CYAN);
        block60.setEditable(false);
        block61.setText(String.valueOf(level.matrizCorrecta1[2][6]));
        block61.setBackground(Color.CYAN);
        block61.setEditable(false);
        block69.setText(String.valueOf(level.matrizCorrecta1[4][8]));
        block69.setBackground(Color.CYAN);
        block69.setEditable(false);
        block72.setText(String.valueOf(level.matrizCorrecta1[5][8]));
        block72.setBackground(Color.CYAN);
        block72.setEditable(false);
        block73.setText(String.valueOf(level.matrizCorrecta1[6][6]));
        block73.setBackground(Color.CYAN);
        block73.setEditable(false);
        block74.setText(String.valueOf(level.matrizCorrecta1[6][7]));
        block74.setBackground(Color.CYAN);
        block74.setEditable(false);
        block75.setText(String.valueOf(level.matrizCorrecta1[6][8]));
        block75.setBackground(Color.CYAN);
        block75.setEditable(false);
        block76.setText(String.valueOf(level.matrizCorrecta1[7][6]));
        block76.setBackground(Color.CYAN);
        block76.setEditable(false);
        block77.setText(String.valueOf(level.matrizCorrecta1[7][7]));
        block77.setBackground(Color.CYAN);
        block77.setEditable(false);
        block78.setText(String.valueOf(level.matrizCorrecta1[7][8]));
        block78.setBackground(Color.CYAN);
        block78.setEditable(false);
        block79.setText(String.valueOf(level.matrizCorrecta1[8][6]));
        block79.setBackground(Color.CYAN);
        block79.setEditable(false);
        block80.setText(String.valueOf(level.matrizCorrecta1[8][7]));
        block80.setBackground(Color.CYAN);
        block80.setEditable(false);
        block81.setText(String.valueOf(level.matrizCorrecta1[8][8]));
        block81.setBackground(Color.CYAN);
        block81.setEditable(false);
    }
    ...
    public void colores(){
        ...
        if(level.colors[2][0]==1){
            block7.setBackground(Color.GREEN);
            contador++;
        }else{
            block7.setBackground(Color.RED);
        }
        ...
        if(level.colors[4][2]==1){
            block15.setBackground(Color.GREEN);
            contador++;
        }else{
            block15.setBackground(Color.RED);
        }
        if(level.colors[5][0]==1){
            block16.setBackground(Color.GREEN);
            contador++;
        }else{
            block16.setBackground(Color.RED);
        }
        ...
        if(level.colors[7][2]==1){
            block24.setBackground(Color.GREEN);
            contador++;
        }else{
            block24.setBackground(Color.RED);
        }
        ...
        if(level.colors[0][5]==1){
            block30.setBackground(Color.GREEN);
            contador++;
        }else{
            block30.setBackground(Color.RED);
        }
        ...
        if(level.colors[1][5]==1){
            block33.setBackground(Color.GREEN);
            contador++;
        }else{
            block33.setBackground(Color.RED);
        }
        ...
        if(level.colors[3][3]==1){
            block37.setBackground(Color.GREEN);
            contador++;
        }else{
            block37.setBackground(Color.RED);
        }
        ...
        if(level.colors[7][3]==1){
            block49.setBackground(Color.GREEN);
            contador++;
        }else{
            block49.setBackground(Color.RED);
        }
        ...
        if(level.colors[7][5]==1){
            block51.setBackground(Color.GREEN);
            contador++;
        }else{
            block51.setBackground(Color.RED);
        }
        if(level.colors[8][3]==1){
            block52.setBackground(Color.GREEN);
            contador++;
        }else{
            block52.setBackground(Color.RED);
        }
        ...
        if(level.colors[1][6]==1){
            block58.setBackground(Color.GREEN);
            contador++;
        }else{
            block58.setBackground(Color.RED);
        }
        ...
        if(level.colors[2][8]==1){
            block63.setBackground(Color.GREEN);
            contador++;
        }else{
            block63.setBackground(Color.RED);
        }
        ...
        if(level.colors[3][8]==1){
            block66.setBackground(Color.GREEN);
            contador++;
        }else{
            block66.setBackground(Color.RED);
        }
        if(level.colors[4][6]==1){
            block67.setBackground(Color.GREEN);
            contador++;
        }else{
            block67.setBackground(Color.RED);
        }
    ...
    public void delate(){
        ...
        block15.setText("");
        block15.setBackground(Color.WHITE);
        block16.setText("");
        block16.setBackground(Color.WHITE);
        block17.setText("");
        ...
        block49.setText("");
        block49.setBackground(Color.WHITE);
        block50.setText("");
        block50.setBackground(Color.WHITE);
        block51.setText("");
        block51.setBackground(Color.WHITE);
        block52.setText("");
        block52.setBackground(Color.WHITE);
        block57.setText("");
        block57.setBackground(Color.WHITE);
        block58.setText("");
        block58.setBackground(Color.WHITE);
        block62.setText("");
        block62.setBackground(Color.WHITE);
        block63.setText("");
        block63.setBackground(Color.WHITE);
        block64.setText("");
        block64.setBackground(Color.WHITE);
        block65.setText("");
        block65.setBackground(Color.WHITE);
        block66.setText("");
        block66.setBackground(Color.WHITE);
        block67.setText("");
        block67.setBackground(Color.WHITE);
        block68.setText("");
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Deben estar TODAS las casillas llenas antes de checar");
    ...
    private void CheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckAnswerActionPerformed
        ...
        level.check(matrizChecar, level.matrizCorrecta1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GameInterface1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GameInterface1().setVisible(true);
