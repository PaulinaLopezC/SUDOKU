 ...
 * @author Paulina
 */
public class GameInterface3 extends javax.swing.JFrame {
    // Composition of the logic level to the game interface of level 3
    private Level level;
    ...
    /**
     * Creates new form GameInterface3
     */
    ...
    public void empezarJuego(){
        ...
        block1.setText(String.valueOf(level.matrizCorrecta3[0][0]));
        //COLOR DEL FONDO DE LA TEXTFIELD
        block1.setBackground(Color.MAGENTA);
        // FALSE PARA QUE EL USUARIO NO PUEDA EDITAR ESA TEXTFIELD
        block1.setEditable(false);
        block2.setText(String.valueOf(level.matrizCorrecta3[0][1]));
        block2.setBackground(Color.MAGENTA);
        block2.setEditable(false);
        block4.setText(String.valueOf(level.matrizCorrecta3[1][0]));
        block4.setBackground(Color.MAGENTA);
        block4.setEditable(false);
        block8.setText(String.valueOf(level.matrizCorrecta3[2][1]));
        block8.setBackground(Color.MAGENTA);
        block8.setEditable(false);
        block9.setText(String.valueOf(level.matrizCorrecta3[2][2]));
        block9.setBackground(Color.MAGENTA);
        block9.setEditable(false);
        block10.setText(String.valueOf(level.matrizCorrecta3[3][0]));
        block10.setBackground(Color.MAGENTA);
        block10.setEditable(false);
        block13.setText(String.valueOf(level.matrizCorrecta3[4][0]));
        block13.setBackground(Color.MAGENTA);
        block13.setEditable(false);
        block16.setText(String.valueOf(level.matrizCorrecta3[5][0]));
        block16.setBackground(Color.MAGENTA);
        block16.setEditable(false);
        block20.setText(String.valueOf(level.matrizCorrecta3[6][1]));
        block20.setBackground(Color.MAGENTA);
        block20.setEditable(false);
        block29.setText(String.valueOf(level.matrizCorrecta3[0][4]));
        block29.setBackground(Color.MAGENTA);
        block29.setEditable(false);
        block31.setText(String.valueOf(level.matrizCorrecta3[1][3]));
        block31.setBackground(Color.MAGENTA);
        block31.setEditable(false);
        block32.setText(String.valueOf(level.matrizCorrecta3[1][4]));
        block32.setBackground(Color.MAGENTA);
        block32.setEditable(false);
        block33.setText(String.valueOf(level.matrizCorrecta3[1][5]));
        block33.setBackground(Color.MAGENTA);
        block33.setEditable(false);
        block38.setText(String.valueOf(level.matrizCorrecta3[3][4]));
        block38.setBackground(Color.MAGENTA);
        block38.setEditable(false);
        block40.setText(String.valueOf(level.matrizCorrecta3[4][3]));
        block40.setBackground(Color.MAGENTA);
        block40.setEditable(false);
        block42.setText(String.valueOf(level.matrizCorrecta3[4][5]));
        block42.setBackground(Color.MAGENTA);
        block42.setEditable(false);
        block44.setText(String.valueOf(level.matrizCorrecta3[5][4]));
        block44.setBackground(Color.MAGENTA);
        block44.setEditable(false);
        block49.setText(String.valueOf(level.matrizCorrecta3[7][3]));
        block49.setBackground(Color.MAGENTA);
        block49.setEditable(false);
        block50.setText(String.valueOf(level.matrizCorrecta3[7][4]));
        block50.setBackground(Color.MAGENTA);
        block50.setEditable(false);
        block51.setText(String.valueOf(level.matrizCorrecta3[7][5]));
        block51.setBackground(Color.MAGENTA);
        block51.setEditable(false);
        block53.setText(String.valueOf(level.matrizCorrecta3[8][4]));
        block53.setBackground(Color.MAGENTA);
        block53.setEditable(false);
        block62.setText(String.valueOf(level.matrizCorrecta3[2][7]));
        block62.setBackground(Color.MAGENTA);
        block62.setEditable(false);
        block66.setText(String.valueOf(level.matrizCorrecta3[3][8]));
        block66.setBackground(Color.MAGENTA);
        block66.setEditable(false);
        block69.setText(String.valueOf(level.matrizCorrecta3[4][8]));
        block69.setBackground(Color.MAGENTA);
        block69.setEditable(false);
        block72.setText(String.valueOf(level.matrizCorrecta3[5][8]));
        block72.setBackground(Color.MAGENTA);
        block72.setEditable(false);
        block73.setText(String.valueOf(level.matrizCorrecta3[6][6]));
        block73.setBackground(Color.MAGENTA);
        block73.setEditable(false);
        block74.setText(String.valueOf(level.matrizCorrecta3[6][7]));
        block74.setBackground(Color.MAGENTA);
        block74.setEditable(false);
        block78.setText(String.valueOf(level.matrizCorrecta3[7][8]));
        block78.setBackground(Color.MAGENTA);
        block78.setEditable(false);
        block80.setText(String.valueOf(level.matrizCorrecta3[8][7]));
        block80.setBackground(Color.MAGENTA);
        block80.setEditable(false);
        block81.setText(String.valueOf(level.matrizCorrecta3[8][8]));
        block81.setBackground(Color.MAGENTA);
    ...
    public void colores(){
        ...
        if(level.colors[1][2]==1){
            block6.setBackground(Color.GREEN);
            contador++;
        }else{
            block6.setBackground(Color.RED);
        }
        ...
        if(level.colors[6][0]==1){
            block19.setBackground(Color.GREEN);
            contador++;
        }else{
            block19.setBackground(Color.RED);
        }
        ...
        if(level.colors[8][1]==1){
            block26.setBackground(Color.GREEN);
            contador++;
        }else{
            block26.setBackground(Color.RED);
        }
        ...
        if(level.colors[0][3]==1){
            block28.setBackground(Color.GREEN);
            contador++;
        }else{
            block28.setBackground(Color.RED);
        }
        ...
        if(level.colors[3][5]==1){
            block39.setBackground(Color.GREEN);
            contador++;
        }else{
            block39.setBackground(Color.RED);
        }
        ...
        if(level.colors[5][3]==1){
            block43.setBackground(Color.GREEN);
            contador++;
        }else{
            block43.setBackground(Color.RED);
        }
        if(level.colors[5][5]==1){
            block45.setBackground(Color.GREEN);
            contador++;
        }else{
            block45.setBackground(Color.RED);
        }
        ...
        if(level.colors[8][5]==1){
            block54.setBackground(Color.GREEN);
            contador++;
        }else{
            block54.setBackground(Color.RED);
        }
        ...
        if(level.colors[0][7]==1){
            block56.setBackground(Color.GREEN);
            contador++;
        }else{
            block56.setBackground(Color.RED);
        }
        ...
        if(level.colors[6][8]==1){
            block75.setBackground(Color.GREEN);
            contador++;
        }else{
            block75.setBackground(Color.RED);
        }
        if(level.colors[7][6]==1){
            block76.setBackground(Color.GREEN);
            contador++;
        }else{
            block76.setBackground(Color.RED);
        }
    ...
    public void delate(){
        ...
        block19.setText("");
        block19.setBackground(Color.WHITE);
        block21.setText("");
        ...
        block26.setText("");
        block26.setBackground(Color.WHITE);
        block27.setText("");
        block27.setBackground(Color.WHITE);
        block28.setText("");
        block28.setBackground(Color.WHITE);
        block30.setText("");
        ...
        block39.setText("");
        block39.setBackground(Color.WHITE);
        block41.setText("");
        block41.setBackground(Color.WHITE);
        block43.setText("");
        block43.setBackground(Color.WHITE);
        block45.setText("");
        block45.setBackground(Color.WHITE);
        block46.setText("");
        ...
        block54.setText("");
        block54.setBackground(Color.WHITE);
        block55.setText("");
        block55.setBackground(Color.WHITE);
        block56.setText("");
        block56.setBackground(Color.WHITE);
        block57.setText("");
        ...
        block75.setText("");
        block75.setBackground(Color.WHITE);
        block76.setText("");
        block76.setBackground(Color.WHITE);
        block77.setText("");
    ...
    private void CheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckAnswerActionPerformed
        ...
        level.check(matrizChecar, level.matrizCorrecta3);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GameInterface3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GameInterface3().setVisible(true);
            }
        });
    }
